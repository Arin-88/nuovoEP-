...
class SidecarManager:
    ...
    # HLS clients signal playback end by stopping segment requests. Keep a
    # short grace period, then terminate the isolated process so its RSS is
    # returned to the OS instead of waiting for Python's allocator.
